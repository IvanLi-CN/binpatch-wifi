...
Domains and stacks are discoverable via `python search.py --help`.
...
if __name__ == "__main__":
    ...
    parser.add_argument("--stack", "-s", choices=AVAILABLE_STACKS, help="Stack-specific search (see available choices)")
